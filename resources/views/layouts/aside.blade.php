                ...
                <ul id="dropdown-administration" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="{{route('admin-productos')}}"
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">Admin Productos</span>
                        </a>
                    </li>
                    @endcan
                    ...
                    @endcan
                    @can('admin.categorias.egresos')
                    <li>
                        <a href="{{route('admin-categorias-egresos')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                            <i class="fa-solid fa-hand-holding-dollar"></i>
                            <span class="flex-1 ms-3 whitespace-nowrap">Categorías Egresos</span>
                        </a>
                    </li>
                    @endcan
                    @can('admin.ordenes')
