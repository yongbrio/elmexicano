@if($column->isSortable())
    <a href="#"
       class="flex items-center gap-1 px-3 py-2 text-sm font-bold whitespace-nowrap"
...
@else
    <span class="flex px-3 py-2 text-sm font-bold whitespace-nowrap">{{ $column->label() }}</span>
@endif
