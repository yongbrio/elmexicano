<div>
    <h1 class="pt-2">Administrar Inventario</h1>
        ...
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab"
            ...
            <li class="me-2" role="presentation">
                <button
                    ...
                    id="registrar-inventario-tab" data-tabs-target="#registrar-inventario" type="button" role="tab"
                    aria-controls="registrar-inventario" aria-selected="false">Registrar inventario</button>
            </li>
            <li class="me-2" role="presentation">
                <button
                    class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
    ...
    <div id="tab-inventario">
        <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="lista-inventario" role="tabpanel"
            ...
            <livewire:administracion.inventario.lista-inventario-table>
        </div>
        <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="registrar-inventario" role="tabpanel"
            aria-labelledby="registrar-inventario-tab">
            <livewire:administracion.inventario.registrar-inventario>
        </div>
