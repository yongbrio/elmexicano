<div>
    ...
    <div class="relative pt-2 overflow-x-auto shadow-md sm:rounded-lg">
        <div
            class="block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            ...
            <table class="w-full text-sm text-left text-gray-500 rtl:text-right dark:text-gray-400">
                ...
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="w-full py-3 text-center" colspan="5">
                            Transferencias de inventario pendientes para ser procesadas
                        </th>
                    </tr>
                    <tr>
                ...
                <tbody>
                    ...
                    @endforeach
                    @endisset
                    @empty($listaTransferencias)
                    <tr>
                        <td colspan="5" class="px-6 py-4 text-center text-gray-500">
                            No hay transferencias de inventario disponibles.
                        </td>
                    </tr>
                    @endempty
                </tbody>
