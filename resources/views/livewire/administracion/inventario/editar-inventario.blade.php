<div>
    ...
    <h1 class="pt-2 mb-5">Editar datos de Inventario</h1>
    ...
    <div class="grid grid-cols-1 gap-4 text-sm sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        ...
        <x-live-wire-input label="Producto" id="codigo_producto" icon="fa-solid fa-location-dot" model="codigo_producto"
            placeholder="" typeInput="text" disabled="disabled">
        </x-live-wire-input>
    ...
    <div class="flex justify-end mt-5">
        <button wire:click="cancelarActualizarInventario" type="button"
        ...
        <button wire:click="actualizarInventario" type="button"
            class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
            <div wire:loading.remove wire:target="actualizarInventario">
                <i class="fa-solid fa-floppy-disk"></i> Actualizar
            </div>
            <div wire:loading wire:target="actualizarInventario">
                Actualizando...
            </div>
        </button>
    </div>
