<div>
    <h1 class="pt-2 mb-5">Actualizar datos de Cuenta Bancaria</h1>
    <div class="grid grid-cols-1 gap-4 text-sm sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        ...
        <x-live-wire-input label="Fecha de apertura" id="fecha_apertura" icon="fa-solid fa-calendar-days"
            model="fecha_apertura" placeholder="Fecha de apertura" typeInput="date"></x-live-wire-input>
    ...
    <div class="flex justify-end mt-5">
        ...
        <button wire:click="cancelarActualizarCuentaBancaria" type="button"
        ...
        <button wire:click="actualizarCuentaBancaria" type="button"
            class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
            <div wire:loading.remove wire:target="actualizarCuentaBancaria">
                <i class="fa-solid fa-floppy-disk"></i> Actualizar
            </div>
            <div wire:loading wire:target="actualizarCuentaBancaria">
                Cargando...
            </div>
        </button>
