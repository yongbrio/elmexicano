<div>
    ...
    <div class="grid grid-cols-1 gap-4 mt-5 text-sm sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2">
        ...
        <div class="grid grid-cols-1 gap-4 text-sm mb-7 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1">

            <div>
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="imagen">Seleccione foto
                    de la CC</label>
                <input
    ...
    <div class="flex justify-end mt-5">
        <button wire:click="cancelarRegistrarUsuario" type="button"
        ...
        <button wire:click="registrarUsuario" type="button"
            class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
            <div wire:loading.remove wire:target="registrarUsuario">
                <i class="fa-solid fa-floppy-disk"></i> Guardar
            </div>
            <div wire:loading wire:target="registrarUsuario">
                Cargando...
            </div>
        </button>
    </div>
