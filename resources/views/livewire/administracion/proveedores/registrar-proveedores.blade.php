<div>
    <div class="grid grid-cols-1 gap-4 text-sm sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        ...
        <x-live-wire-input label="Sucursal" id="sucursal" icon="fa-solid fa-ruler-horizontal" model="sucursal"
            placeholder="Nombre sucursal" typeInput="text"></x-live-wire-input>
    ...
    <div class="flex justify-end mt-5">
        <button wire:click="cancelarRegistrarProveedor" type="button"
        ...
        <button wire:click="registrarProveedor" type="button"
            class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
            <div wire:loading.remove wire:target="registrarProveedor">
                <i class="fa-solid fa-floppy-disk"></i> Guardar
            </div>
            <div wire:loading wire:target="registrarProveedor">
                Cargando...
            </div>
        </button>
    </div>
