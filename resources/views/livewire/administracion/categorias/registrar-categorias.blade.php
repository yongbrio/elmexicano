<div>
    ...
    <div class="grid grid-cols-1">
        ...
        <x-live-wire-input label="Nombre de la categoría" id="nombre_categoria" icon="fa-solid fa-money-check-dollar"
            model="nombre_categoria" placeholder="Nombre de la categoría" typeInput="text"></x-live-wire-input>
    ...
    <div class="flex justify-end mt-5">
        ...
        <button data-modal-hide="modal-agregar-categoria" type="button" id="close-modal-registrar"
        ...
        <button wire:click="registrarCategoria" wire:click="$refresh" type="button"
            class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
            <div wire:loading.remove wire:target="registrarCategoria">
                <i class="fa-solid fa-floppy-disk"></i> Guardar
            </div>
            <div wire:loading wire:target="registrarCategoria">
                Cargando...
            </div>
        </button>
